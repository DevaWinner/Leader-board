...
**Leader Board** project is built using an API. The project allows users to submit their scores to a leaderboard, and the scores are then displayed in a ranked order. The API used to store the scores is a simple API.
...
1. Clone this repository
   run
   ```sh 
      git clone git@github.com:DevaWinner/Leader-board.git
    ```
